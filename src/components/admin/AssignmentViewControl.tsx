import { matchStatuses, ndaStatuses } from "@/constants/assignedData";
import {
  clearFilters,
  toggleMatchStatus,
  toggleNDAStatus,
...
interface AssignmentFiltersSectionProps {
  selectedView: string;
...
export default function AssignmentFiltersSection({
  selectedView,
  setSelectedView,
  selectedNDAStatus,
