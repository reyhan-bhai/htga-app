          ...
          {status === "success" ? (
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm mb-6">
                If the account exists, we have sent password recovery
                instructions.
              </p>
              <Link
                href="/"
                className="block w-full bg-gray-100 hover:bg-gray-200 text-gray-800 font-bold py-3 rounded-xl transition-colors"
              >
                Back to Login
              </Link>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                className="w-full bg-[#FFA200] hover:bg-[#FF9500] text-white font-bold py-4 rounded-xl shadow-lg transition-all mb-4 disabled:opacity-50"
              >
              ...
              <Link
                href="/"
                className="block text-center text-gray-500 text-sm hover:text-gray-800 font-medium"
              >
